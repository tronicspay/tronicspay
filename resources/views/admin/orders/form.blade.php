                    ...
                    <div class="col-xs-6 col-md-6">
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    <tr>
                                        <th style="width:50%">Original Cash Offer:</th>
                                        <td><strong>${{ number_format($overallSubTotal, 2, '.', ',') }}</strong></td>
                                    ...
                                    <!-- <tr>
                                        <th>Final payout:</th>
                                        <td><strong>${{ number_format($overallSubTotal + $shippingFee - $order['insurance_cost'], 2, '.', ',') }}</strong></td>
                                    </tr> -->
                                    <!-- <tr>
                                        <th>Final Cash Offer:</th>
                                        <td>
                                            <?php
                                            // $total = $overallSubTotal + $shippingFee - $order['insurance_cost'];
                                            // echo '$' . number_format($overallSubTotal + $shippingFee - $order['insurance_cost'], 2, '.', ',');
                                            ?>
                                        </td>
                                    </tr> -->
                                </tbody>
